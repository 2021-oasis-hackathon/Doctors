...
public class FragmentHealthData extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_health_data, container, false);
    ...
    private void initUI(ViewGroup rootView) {
        ...
        // 질환 추가
        addDiseaseBtn = rootView.findViewById(R.id.addDiseaseBtn);
        ...
        imgCapture = rootView.findViewById(R.id.imgCapture);
        ...
        // 다음 버튼
        btnNext2 = rootView.findViewById(R.id.btnNext2);
        btnNext2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // fragment_health_data2로 전환
                FragmentHealthData2 fragmentHealthData2 = new FragmentHealthData2();
                FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.container, fragmentHealthData2);
                transaction.commit();
            }
        });
    }
