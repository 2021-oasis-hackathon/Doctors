    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        checkButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 정보 전달
                Bundle bundle3 = new Bundle();  // bundle으로 값 전달
                bundle3.putInt("switch", 2); // bundle에 넘길 값 저장
                if (fragmentName.equals("fragmentChild4")) {
                    FragmentChild4 fragmentChild4 = new FragmentChild4();  // 피부과(가까움)
                    FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                    fragmentChild4.setArguments(bundle3);  // bundle을 SecondFragment로 보낼 준비
                    ...
                    FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                    fragmentChild5.setArguments(bundle3);  // bundle을 SecondFragment로 보낼 준비
                    ...
                    FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                    fragmentChild8.setArguments(bundle3);  // bundle을 SecondFragment로 보낼 준비
